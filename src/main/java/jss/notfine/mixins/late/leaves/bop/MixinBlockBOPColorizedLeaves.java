...
@Mixin(value = BlockBOPColorizedLeaves.class)
public abstract class MixinBlockBOPColorizedLeaves extends BlockLeavesBase {
    ...
    @Shadow(remap = false)
    @Final
    private BlockBOPColorizedLeaves.ColourizedLeafCategory category;

    private MixinBlockBOPColorizedLeaves(Material material, boolean overridden) {
